...
PRODUCTS = [
    ...
    (
        ...
        "caramel_malt.jpg",
        "3.00",
        "Head retention in darker beers",
    ),
    ("Saaz Hops", "saaz-hops", "hops", "saaz_hops.jpg", "4.75", "Essential for Lagers"),
    (
        "Pilsner Malt",
        "pilsner-malt",
        "malts",
    ...
    (
        ...
        "imperial_yeast.jpg",
        "8.99",
        "American ales with citrus notes",
    ),
    (
        "Centennial Hops",
        "centennial-hops",
