...
class UpdateUserPasswordView( generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if new_password != new_password_confirm:
            return Response({"new_password_confirm": ["New password and confirmation do not match."]}, status=status.HTTP_400_BAD_REQUEST)
...
class RegisterView(mixins.CreateModelMixin, generics.GenericAPIView,mixins.UpdateModelMixin):
